//
//  LEFavoriteViewController.swift
//  Leisure
//
...
class LEFavoriteViewController: UIViewController, LEFavoriteDelegate {
    @IBOutlet weak var tableView: UITableView!
    @IBOutlet weak var activityIndicator: UIActivityIndicatorView!
    let playerViewController = AVPlayerViewController()
    let viewModel = LEFavoriteViewModel()
...
extension LEFavoriteViewController: UITableViewDelegate, UITableViewDataSource {
...
extension LEFavoriteViewController: SearchMovieCellDelegate {
